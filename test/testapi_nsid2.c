...
int main(){
    ...
    char packet_bytes[] = {
      ...
      0x0a, 0x00, 0x03, 0x00, 0x06, 0x36, 0x30, 0x39,
      0x6d, 0x35//, 0x36        // one byte of the NSID in this packet is missing (commented out)
                                // but the length of NSID is still 0x06. we expect to get 
