...
// asking for NSID from a packet which has ends0 but does not have NSID


int main(){
    char packet_bytes[] = {
      0xc3, 0x38, 0x81, 0x80, 0x00, 0x01, 0x00, 0x02,
      ...
      0x00, 0x04, 0xbc, 0x72, 0x61, 0x03, 0xc0, 0x0c,
      0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2c,
      0x00, 0x04, 0xbc, 0x72, 0x60, 0x03, 0x00, 0x00,
    ...
    assert(dns->msg->header.id == 0xc338);
